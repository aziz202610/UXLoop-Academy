...
const courses = [
  { id: 1, title: "UX/UI Design Bootcamp", href: "/courses/week-1", badge: "Populaire", badgeColor: "bg-brand-purple", videos: 48, weeks: 8, progress: 0, price: "49 000 FCFA", gradient: "from-brand-purple-light to-brand-yellow-light" },
  { id: 2, title: "Figma Avancé", href: "#", badge: "Nouveau", badgeColor: "bg-brand-blue", videos: 24, weeks: 4, progress: 0, price: "29 000 FCFA", gradient: "from-brand-blue-light to-brand-turquoise-light" },
  { id: 3, title: "Design System Mastery", href: "#", badge: "Disponible", badgeColor: "bg-state-success", videos: 32, weeks: 6, progress: 0, price: "39 000 FCFA", gradient: "from-brand-yellow-light to-brand-purple-light" },
];
