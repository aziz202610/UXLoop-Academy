...
const courses = [
  {
    ...
    progress: 0,
    price: "49 000 FCFA",
    gradient: "from-brand-purple-light to-brand-yellow-light",
  },
  {
    id: 2,
    title: "Figma Avance",
    href: "/courses/figma-avance",
    badge: "Nouveau",
    ...
    progress: 0,
    price: "29 000 FCFA",
    gradient: "from-brand-blue-light to-brand-turquoise-light",
  },
  {
    id: 3,
    ...
    href: "#",
    badge: "Disponible",
    badgeColor: "bg-state-success",
    videos: 32,
    weeks: 6,
    progress: 0,
    price: "39 000 FCFA",
    gradient: "from-brand-yellow-light to-brand-purple-light",
  },
];
          ...
          <Link href={course.href} key={course.id}>
            ...
            >
              <div className={`h-28 bg-gradient-to-br ${course.gradient} flex items-center justify-center relative`}>
                <span className={`absolute top-3 left-3 ${course.badgeColor} text-white text-[10px] font-semibold px-2.5 py-1 rounded-full`}>
                  {course.badge}
                </span>
              ...
              <div className="p-5">
                ...
                <div className="flex gap-4 text-xs text-text-secondary mb-4">
                  <span className="flex items-center gap-1"><Play className="w-3 h-3" /> {course.videos} videos</span>
                  <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> {course.weeks} semaines</span>
                </div>
                <ProgressBar progress={course.progress} />
                <div className="flex justify-between items-center mt-3 text-sm">
                  <span className="text-text-secondary">{course.progress}% complete</span>
